...
> Корпоративная система push-уведомлений для Unix подобной ОС с интеграцией Ansible.  
...
| Alt Linux  10.4        | Astra Linux 1.8         | Red OS  8.0.2           |
|------------------------|-------------------------|------------------------|
...
|---|---|
| ОС | GNU/Linux | ALT Linux (Сизиф, p10, p11) | RedOS 8.0.2 | AstraLinux 1.8 | 
| Python | 3.8+ |
...
*Разработано для автоматизации оповещения в корпоративной инфраструктуре на GNU/Linux.*
