...
**[⬇️ NotifyAgent-Setup.exe](https://github.com/PapaBorscht/Notify/blob/main/win-client/NotifyAgent-Setup.exe)**

2. Запустить от имени администратора
3. Принять лицензионное соглашение и нажать **Далее → Установить**
...
Исходный код агента и инструкция по сборке через PyInstaller находятся в папке [`win-client/`](https://github.com/PapaBorscht/Notify/tree/main/win-client).
